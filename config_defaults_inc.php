...
# along with MantisBT.  If not, see <http://www.gnu.org/licenses/>.
	 ...
	 */
	$g_password_confirm_hash_magic_string = 'EMIwebDEV';
	 ...
	 */
	$g_administrator_email	= 'webdev@eminc.com';

	/**
	 * Webmaster email
	 * @global string $g_webmaster_email
	 */
	$g_webmaster_email		= 'webdev@eminc.com';

	/**
	 * the sender email, part of 'From: ' header in emails
	 * @global string $g_from_email
	 */
 	$g_from_email			= 'webdev@eminc.com';

	/**
	 * the sender name, part of 'From: ' header in emails
	 * @global string $g_from_name
	 */
	$g_from_name			= 'MantisLIVE Issue Tracker';

	/**
	 * the return address for bounced mail
	 * @global string $g_return_path_email
	 */
	$g_return_path_email	= 'webdev@eminc.com';
	 ...
	 */
	$g_window_title			= 'mantisLIVE Issue Tracking';
	 ...
	 */
	$g_default_email_on_new_minimum_severity		= MAJOR;
	 ...
	 */
	$g_date_partitions			= array( 1, 2, 3, 5, 7, 14, 30, 90, 180,365);
	 ...
	 */
	$g_preview_attachments_inline_max_size = 2048 * 1024;
	 ...
	 */
	$g_monitor_bug_threshold = VIEWER;
	...
	/**
	 * The threshold required for users to be able to create permalinks.  To turn off this feature use NOBODY.
	 ...
	 */
	$g_manage_global_profile_threshold = ADMINISTRATOR;
	 ...
	 */
	$g_allow_freetext_in_profile_fields = OFF;
